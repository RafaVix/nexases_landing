...
export default function ChatWidget({ isOpen, onClose }: ChatWidgetProps) {
  ...
  const handleSendMessage = async () => {
    ...
    // In production, replace [INSERIR_WEBHOOK_URL] with actual endpoint
    try {
      const payload = {
      ...
      // const response = await fetch('[INSERIR_WEBHOOK_URL]', {
      //   method: 'POST',
...
const assistantText = data?.message ?? 'Desculpe, não consegui gerar uma resposta agora.';
      ...
      setTimeout(() => {
        const assistantMessage: Message = {
          ...
          type: "assistant",
          content:
            "Obrigada por compartilhar isso comigo. Vou fazer mais algumas perguntas para entender melhor sua situação. Qual é o valor total aproximado de suas dívidas?",
          timestamp: new Date(),
        };
