...
export default function Header({ onChatOpen }: HeaderProps) {
  return (
    <header className="sticky top-0 z-50 bg-[#F5F7F6] border-b border-[#E0E3E1] shadow-sm">
      {/* Desktop Layout */}
      <div className="hidden md:flex container items-center justify-between py-4 gap-4">
        {/* ESQUERDA: Logo/Marca */}
      ...
      {/* Mobile Layout - Apenas Pill Central */}
      <div className="md:hidden flex items-center justify-center py-3">
        <div className="bg-[#2F6F95] text-white px-5 py-2 rounded-full text-xs font-medium text-center">
          Conheça os caminhos para sair das dívidas
        </div>
      </div>
    </header>
